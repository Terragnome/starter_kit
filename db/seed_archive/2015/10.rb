...
"""
p.body = """
Since reading Born To Run I've run well over 3,000 miles running almost entirely in Vibram Fivefingers and other neutral/barefoot shoes.  The prose is really accessible and it's told kind of like an explorer rediscovering an ancient mystery.  Your results may vary, but prior to reading this book the furthest I'd ever run was four miles wheras afterwards I was regularly knocking out 12 mile runs every weekend.
"""
p.asin = "0307279189"
p.cost = 11
