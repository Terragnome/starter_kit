...
p.summary = """
Four years ago, when Alton Brown set out to write \"I'm Just Here for the Food\", he wanted to create a cookbook unlike any other - a cookbook for people who would rather understand their food than follow a recipe. A mix of cutting edge graphics and a fresh take on preparing food, \"I'm Just Here for the Food\" became one of the best-selling cookbooks of the year - and received the James Beard Foundation/KitchenAid Book Award as best reference book.
"""
p.body = """
