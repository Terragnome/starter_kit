...
'''
p.body = '''
Jamón is a $1.65 billion industry in Spain, and these traditionally dry-cured jamons to preserve them and delight taste buds for centuries.  This 16-18 lbs bone in jamon serrano makes an elegant and delicious centerpiece for your table.  Keep it away from heat and moisture and it\'ll keep for months.  For an extra treat, Jamón Iberico is twice the cost as Serrano but is made from which is made from Black Iberian pigs that put on more fat and are fed a diet of acorns.
'''
p.asin = "B0015QSGVI"
p.cost = 250
